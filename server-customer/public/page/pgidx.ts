...
class PageIndexApi {
    ...
    static async getPageList() {
        try {
            ...
            PageIndexApi.renderPageList(totalPages, PageIndexApi.docName, PageIndexApi.chapterId);
        } catch (error) {
    ...
    static renderPageList(totalPages: number, docName: string, chapterId: number) {
